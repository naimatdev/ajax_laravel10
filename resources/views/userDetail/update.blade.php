...
@section('content')
    ...
    <form action="" method="post" id="myForm">
        ...
        <div class="form-group  col-md-4">
            ...
            <input type="text" name="father_name" id="" class="form-control"  value="{{ $user->father_name }}">
        </div>
        <div class="form-group  col-md-4">
            <label for="">mobile_number</label>
            <input type="number" name="mobile_number" id="" class="form-control"  value="{{ $user->mobile_number }}">
        </div>
        <div class="form-group  col-md-4">
